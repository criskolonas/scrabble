    ...
    def guidelines(self):
        '''Το παιχνίδι Σκραμπλ. Ο αλγόριθμος του υπολογιστή που χρησιμοποιήθηκε βασίζεται στο σενάριο 1 του pdf.
            ...
            Για την μέθοδο play υλοποιήθηκαν οι αλγόριθμοιτου σεναρίου 1 και 2.
              ...
              - Smart - Fail (ΑΕΜ: 2933): Χρησιμοποιήθηκε διαφορετικό implementation του smart από ότι στο παραπάνω
               σενάριο. Ο fail αρχικά υπολογίζει τον μέσο όρο από τα βάρη των διαθέσιμων permutations ανά γύρο, και
               αφαιρεί τις λέξεις με βάρος μικρότερο από το μέσο, με τη βοήθεια της λίστας target_keys. Έπειτα, αφού
               αποθηκεύσει τα βάρη των λέξεων που μείνανε, με την βοήθεια της built-in συνάρτησης choices της
               βιβλιοθήκης random, "διαλέγει", ανάλογα με το βάρος της κάθε λέξης και τον παράγοντα της τύχης, μια λέξη
               για να παίξει ο υπολογιστής, χωρίς αυτή πάντα να είναι η καλύτερη διαθέσιμη, προσομοιώνοντας κάπως
               καλύτερα τον παράγοντα του ανθρώπινου λάθους στην επιλογή του.
